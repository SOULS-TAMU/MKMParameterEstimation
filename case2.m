...
% -------------------------
syms x1 x2 x3 k1 k2 real
x = [x1; x2; x3; k1; k2];

syms lam1 lam2 lam3 real
lam = [lam1; lam2; lam3];

syms mu1 mu2 mu3 mu4 mu5 real
...
% -------------------------
f  = (1.5851 - x1)^2 + (14.563 - x2)^2 + (16.851-x3)^2;

h1 = (30-x1)+10*(-k1*x1^2-k2*x1);
h2 = (2-x2)+10*(k1*x1^2);
h3 = (1-x3)+10*(k2*x1);
h  = [h1; h2; h3];
...
maxFeasIter = 400;          % 50–200 is typical
...
if do_feasibility_first
    ...
    lamk = [0; 0;0];
    muk  = [0; 0; 0;0;0];  % keep your mu as-is
end
